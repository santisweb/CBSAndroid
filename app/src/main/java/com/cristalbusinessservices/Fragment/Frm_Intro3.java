...
public class Frm_Intro3 extends Fragment {
    int height, wwidth;
    @BindView(R.id.img)
    AppCompatImageView img;

    public static Frm_Intro3 newInstance(int page, String title) {
        Frm_Intro3 frm_intro1 = new Frm_Intro3();
        return frm_intro1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            getWidthHeight();
            view = inflater.inflate(R.layout.frm_intro3, container, false);
